...
{id:'creation',file:'creation',name:'Creation',nodes:20,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Cell freq','Wave rate','Tint','Trail'],set:{stage:.6}},
{id:'drivetraincore',file:'drivetraincore',name:'DrivetrainCore',nodes:24,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Cadence','Gear','Chainring','Torque blur'],set:{stage:.6}},
{id:'interstellar',file:'interstellar',name:'Interstellar',nodes:20,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Scroll rate','Stellar','Amount','Trail'],set:{stage:.6}},
{id:'trisquaretwist',file:'trisquaretwist',name:'TriSquareTwist',nodes:21,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Shape','Twist','Zoom','Rings'],set:{stage:.6}},
{id:'waveformhorizon',file:'waveformhorizon',name:'WaveformHorizon',nodes:13,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Wave freq','Trail','Glow'],set:{stage:.6}},
{id:'waveformsignal',file:'waveformsignal',name:'waveform_signal',nodes:13,bpm:false,
 map:[['bass','Thrust'],['mid','Velocity'],['high','Spark']],
 params:['Streak density','Speed','Glow'],set:{stage:.6}},
{id:'linescape',file:'linescape',name:'Linescape',nodes:21,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Travel','Relief','Slices','Trail'],set:{stage:.6}},
{id:'spheredots',file:'spheredots',name:'SphereDots',nodes:22,bpm:true,
 map:[['bass','Centre warp'],['mid','Cell ripple'],['high','Rim sparkle']],
 params:['Spin rate','Dot density','Dot size','Tilt'],set:{stage:.6}},
