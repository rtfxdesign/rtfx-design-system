...
/* wide screens: the grid breaks out (site.css); larger cards keep it at four across */
@media (min-width: 1440px) { .art-grid { grid-template-columns: repeat(auto-fit, minmax(380px, 1fr)); } }
