...
// Section headers: no ambient wave (the bgfield behind them carries the motion);
// hover displacement runs at roughly half the hero's force so the two effects
...
if(d2<R2&&d2>0.01){var d=Math.sqrt(d2),f=(1-d/R)*FORCE;p.vx+=dx/d*f;p.vy+=dy/d*f;p.heat=1;}
